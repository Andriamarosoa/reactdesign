          ...
          <CSSTransition component="div" classNames="TabsAnimation" appear={true}
            ...
            <Container fluid>
              <Row>
                ...
                <Col md="4">
                  <div className="card mb-3 widget-chart">
                    ...
                    <div className="widget-numbers">
                      <CountUp start={0} end={17.2} separator="" decimals={0} decimal=","
                    ...
                    <div className="widget-description text-warning">
                      <span className="pe-1">
                        <CountUp start={0} end={135.5} separator="," delay={2}
                          decimals={0} decimal="," useEasing={false} prefix="" suffix="%" duration="35"/>
                      </span>
                ...
                <Col md="4">
                  <div className="card mb-3 widget-chart">
                    ...
                    <div className="widget-numbers">
                      <CountUp start={5} end={62.3} separator="," decimals={0} decimal=","
                        prefix="" useEasing={false} suffix="k" duration="25"/>
                    </div>
                ...
                <Col md="4">
                  <div className="card mb-3 widget-chart">
                    ...
                    <div className="widget-numbers">
                      <CountUp start={0} end={2.82} separator="," decimals={2}
                        decimal="," prefix="" useEasing={false} suffix="k" duration="15"/>
                    </div>
                    <div className="widget-subheading">Total Sales</div>
                    <div className="widget-description text-danger">
                      <span className="pe-1">23.1%</span>
                ...
                <Col md="4">
                  <div className="card mb-3 widget-chart">
                    ...
                    <div className="widget-numbers">
                      <CountUp start={14.2} end={31.9} separator="," decimals={0} decimal=","
                        prefix="" useEasing={false} suffix="k" duration="25"/>
                    </div>
                    <div className="widget-subheading">Follow-ups</div>
                    <div className="widget-description text-focus">
                      <FontAwesomeIcon icon={faArrowLeft} />
                      <span className="ps-1">115.5%</span>
                    </div>
                  </div>
                </Col>
              </Row>
              ...
              <Row>
                <Col md="4">
                  <div className="card mb-3 widget-chart">
                    <div className="widget-numbers">1.2M</div>
                    <div className="widget-subheading">Leads Generated</div>
                    <div className="widget-description text-info">
                      <FontAwesomeIcon icon={faEllipsisH} />
                      <span className="ps-1">115.5%</span>
                    </div>
                ...
                <Col md="4">
                  <div className="card mb-3 widget-chart">
                    <div className="widget-numbers">3.47k</div>
                    <div className="widget-subheading">Users Active</div>
                    <div className="widget-description text-danger">
                      <span className="pe-1">31.2%</span>
                      <FontAwesomeIcon icon={faAngleDown} />
                    </div>
                  </div>
                </Col>
                <Col md="4">
                  <div className="card mb-3 widget-chart">
                    <div className="widget-numbers">3.7M</div>
                    <div className="widget-subheading">Lifetime Tickets</div>
                    <div className="widget-description text-warning">
                      <FontAwesomeIcon icon={faArrowRight} />
                      <span className="ps-1">121.9%</span>
                    </div>
                  </div>
                </Col>
              </Row>
              ...
              <Row>
                ...
                <Col md="4">
                  <div className="card mb-3 widget-chart card-hover-shadow-2x">
                    <div className="icon-wrapper border-light rounded">
                      <div className="icon-wrapper-bg bg-light" />
                      <i className="lnr-hourglass icon-gradient bg-love-kiss">
                        {" "}
                      </i>
                    </div>
                    <div className="widget-numbers">1,584</div>
              ...
              <Row>
                ...
                <Col md="4">
                  <div className="card mb-3 widget-chart">
                    ...
                    <div className="widget-numbers">15.8k</div>
                    <div className="widget-subheading">Total Views</div>
                    <div className="widget-description">
                    ...
                    <div className="widget-progress-wrapper">
                      <Progress className="progress-bar-lg progress-bar-animated" color="primary" value="65"/>
                    </div>
                  </div>
                </Col>
                <Col md="4">
                  <div className="card mb-3 widget-chart">
                    ...
                    <div className="widget-description">
                      <span className="text-success ps-1 pe-1">
                        <FontAwesomeIcon icon={faAngleUp} />
                        <span className="ps-1">77.5%</span>
                      </span>
                      new sales leads
                    </div>
                    <div className="widget-progress-wrapper">
                      <Progress className="progress-bar-xs progress-bar-animated" color="info" value="85"/>
                    </div>
                  </div>
                </Col>
              </Row>
