...
function generateData(length){
    return Array.from({ length  }, function(){
        return {
            ...
            cout:formatter.format(casual.double(1000,2000)) ,
...
export function CategorieCoutPage(){
    ...
    return <div className='bg-white h100 p-3'>
        <Row justify={"space-between"}>
            <h1>Liste des Catégories De Coût</h1>
...
export default CategorieCoutPage;
